...
<div 
    id="edit_item_form_{{ $category['id']}}" 
    class="formEidt fixed top-0 left-0 w-full h-full z-[1000] backdrop-blur-md hidden items-center justify-center p-4"
>
        ...
        >
            ...
            <div>
                ...
                <button 
                    type="submit" 
                    data-id="{{ $category['id']}}"
                    class="submit-edit-item bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow-md transition duration-300 cursor-pointer"
                >
                    submit
                </button>
            </div>
